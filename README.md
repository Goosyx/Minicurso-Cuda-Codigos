...
Antes de executar o projeto, verifique a **Compute Capability** da sua GPU e ajuste a flag `-arch` no `Makefile` conforme necessário.
...
- Caso sua GPU apresente erro de compatibilidade, edite a flag `-arch=` no `Makefile` conforme sua arquitetura.
